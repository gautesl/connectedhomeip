...
- ``external_content_link_extensions``: A list of file extensions out of scope.
  All links to content with these file extensions are made external.
...
def adjust_includes(
    ...
    Args:
        ...
        extensions: Filename extensions links to which are made external.
