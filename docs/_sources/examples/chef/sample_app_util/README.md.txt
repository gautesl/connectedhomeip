...
[^hash_note]:
    ...
    [zap_file_parser](https://github.com/project-chip/connectedhomeip/blob/master/zap_file_parser.py) There are some notable details
...
For an example, see [sample_zap_file_hashmeta.yaml](https://github.com/project-chip/connectedhomeip/blob/master/examples/chef/sample_app_util/test_files/sample_zap_file_hashmeta.yaml)
which was generated from [sample_zap_file.zap](https://github.com/project-chip/connectedhomeip/blob/master/examples/chef/sample_app_util/test_files/sample_zap_file.zap).
